...
特别感谢李亚东同学参考https://github.com/kanhao100/GBT7714-2025-bst
对其进行了修改并提供 `gbt7714-2025.bst` 和参考文献格式示例文件，为本次 GB/T 7714—2025 参考文献格式更新提供了重要支持。感谢kanhao100提供的GBT7714-2025-bst项目为本次更新提供了支持。
